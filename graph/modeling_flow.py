...
NODE_MODELING_DELIVERY = "modelling_delivery_generator" # Use the generator
...
def create_modeling_subgraph():
    ...
    workflow.add_node(NODE_MODELING_DELIVERY, modelling_delivery_generator_node) # Point to the generator
