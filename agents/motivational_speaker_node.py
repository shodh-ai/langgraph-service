...
logger.info(f"Using model: {type(gemini_model).__name__} in motivational_speaker_node")
    ...
    if not gemini_model:
        ...
        try:
            ...
            contents = [
                ...
                Content(role="model", parts=[Part.from_text("I understand. I'll generate a motivational message tailored to the student's emotional state and progress.")]),
